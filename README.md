...
- 自助翻译：在扩展弹窗或随身译中输入文本，支持自动识别源语言或手动选择源语言与目标语言；输入单个英文单词时直接展示音标、词性、释义、词形和例句。
...
- 随身译：浏览器右侧悬浮入口，可快速触发整页翻译、自助翻译、历史记录、单词本、Token 用量和 AI 配置；常用功能保持常驻，低频功能通过三点按钮悬停展开；整页翻译支持通过小圆点快速切换仅译文和双语显示。
